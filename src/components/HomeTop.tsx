...
function HomeTop() {
  return (
    <div className='pt-14 px-5 sm:px-12 lg:px-28 border-4' style={{height: 'calc(600px - 64px)'}}>
        ...
        <div className='flex flex-col md:flex-row items-center'>
            ...
            <div className='ml-auto w-full md:w-6/12 lg:w-4/12'>
                <div className='w-full h-72 lg:h-80'>
                    <img src={Map} alt='map' className='w-full h-full opacity-75 hover:opacity-90 md:opacity-100'/>
                </div>
